...
export default function RegisterForm({ embedded = false }) {
  ...
  if (submitted) {
    return (
      <div className={`reg-page split-layout ${embedded ? 'embedded' : ''}`}>
        {!embedded && (
          <>
            {/* Mobile Header */}
        ...
        <div className="split-wrapper">
          ...
          {/* Right panel */}
          <div className={`split-right-panel flex-center ${embedded ? 'embedded' : ''}`}>
            {!embedded && (
              <>
                {/* Mobile Home Button */}
  ...
  return (
    <div className={`reg-page split-layout ${embedded ? 'embedded' : ''}`}>
      ...
      <div className="split-wrapper">
        ...
        {/* Right panel */}
        <div className={`split-right-panel ${embedded ? 'embedded' : ''}`}>
          {!embedded && (
            <>
              {/* Mobile Home Button */}
              <a href="/" className="mobile-home-btn">← Home</a>
